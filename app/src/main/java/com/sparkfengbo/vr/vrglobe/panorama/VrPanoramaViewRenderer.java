...
import com.sparkfengbo.vr.vrglobe.shape.Sphere;
...
public class VrPanoramaViewRenderer implements GLSurfaceView.Renderer {
    ...
    private Sphere mSphere = new Sphere(5);
